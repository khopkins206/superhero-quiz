...
var questions = [{
        ...
        answers: [{
                text: 'Smashing things and yelling',
                value: "Hulk"
            },
            {
                text: 'Giving gifts and incentives',
                value: "Black Widow"
            },
            {
                text: 'Do everything by your self',
                value: "Vision"
            },
            {
                text: 'Talking softly and calmly',
                value: "Captin America"
            },
            {
                text: 'Sitting back and just watching',
                value: "Spider Man"
            }
        ]
    ...
    },
    {
        ...
        answers: [{
                text: 'try and throw the train off the tracks',
                value: "Hulk"
            },
            {
                text: 'try and find a way to hack the train system and stop it',
                value: "Black Widow"
            },
            {
                text: 'stand in front of train and try and deflect it',
                value: "Vision"
            },
            {
                text: 'try to get to the front and pull the breaks',
                value: "Captin America"
            },
            {
                text: 'try to rescue a lot of people at a time',
                value: 'Spider Man'
            }
        ]
    },
    {
        ...
        answers: [{
                text: 'The entire buffet',
                value: "Hulk"
            },
            {
                text: 'Ew, eat at a buffet?',
                value: "Black Widow"
            },
            {
                text: 'Food?',
            ...
            {
                text: 'We didn\'t have thoes back in my day',
                value: "Captin America"
            },
            {
                text: 'Multiple Plates',
                value: 'Spider Man'
            }
        ]
    },
    {
        ...
        answers: [{
                text: 'I do not handle it well',
                value: "Hulk"
            },
            {
                text: 'Ignore it / Push it down',
                value: "Black Widow"
            },
            {
                text: 'Multitasker, thrives in stress',
                value: "Vision"
            },
            {
                text: 'Use it to fuel me',
                value: "Captin America"
            },
            {
                text: 'Laugh through it',
                value: 'Spider Man'
            }
        ]
    ...
    },
    {
        ...
        answers: [{
                text: 'Resolve it your way ',
                value: "Hulk"
            },
            {
                text: 'Seek amicable resolution',
                value: "Black Widow"
            },
            {
                text: 'Make the other person apologize',
                value: "Vision"
            },
            {
                text: 'Make Peace',
